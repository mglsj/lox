...
class Parser {
    ...
    private Expr assignment() {
        Expr expr = or(); // l value

        if (match(EQUAL)) {
            Token equals = previous();
            Expr value = assignment(); // r value
    ...
    /**
     * Match current token with the provided tokens. Consumes it if mach found.
     */
    ...
    /**
     * Checks current token while consuming it. Returns the token if matched. Throws
     * error if not match.
     */
    ...
    /**
     * Moves forward while returning the current token.
     */
